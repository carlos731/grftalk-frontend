        ...
        <div className={`bg-slate-100 dark:bg-slate-900 border-r border-slate-50 dark:border-slate-800 ${variant === "mobile" ? 'w-auto' : 'w-96'} h-app overflow-auto`}>
            ...
            <div className="mt-5">
                {chatsFiltered.map(chat => (
                    ...
                    >
                        <Avatar className="size-[46px]" isOnline={dayjs().subtract(5, 'minute').isBefore(dayjs(chat.user.last_access))}>
                            <AvatarImage
                        ...
                        <div className="space-y-1 flex-1 truncate">
                            <div className="flex item-center justify-between gap-4">
                                <div className="font-bold text-slate-800 dark:text-slate-100 truncate text-eliipsis">
                                    {chat.user.name}
                                </div>
