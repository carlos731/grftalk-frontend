...
export const Footer = ({ onSendMessage }: Props) => {
    ...
    return (
        <div>
            ...
            {messageAttachment &&
                <div className="flex items-center justify-between text-slate-600 dark:text-slate-400 bg-slate-100/80 dark:bg-slate-900 px-10 py-2 border-t">
                    <p className="text-xs">
                ...
                {isRecording ?
                    ...
                    <>
                        <div className="flex items-center gap-2.5">
                            ...
                            <Button variant='ghost' size='icon' title="Emoji" onClick={() => document.getElementById("attachment")?.click()}>
